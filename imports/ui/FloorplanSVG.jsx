...
export const FloorplanSVG = () => {
  ...
  return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 519.08 397.83" style={{maxWidth:700}}>
        <title>FloorplanSVG</title>
        <g id="RoomTemp">
          <rect x="10.67" y="261" width="80.54" height="130" style={{ fill: "#00aeef" }} />
          <rect x="96" y="261" width="82.67" height="130" style={{ fill: "#00aeef" }} />
          <rect x="184" y="261" width="81.67" height="130" style={{ fill: "#00aeef" }} />
          <rect x="271.33" y="261" width="81.67" height="130" style={{ fill: "#00aeef" }} />
          <rect x="357.79" y="261.33" width="80.8" height="130" style={{ fill: "#00aeef" }} />
          <rect x="441.47" y="261" width="77.62" height="130" style={{ fill: "#00aeef" }} />
          <rect x="10.08" y="16" width="196.48" height="142" style={{ fill: "#00aeef" }} />
        </g>
        <g id="Floorplan">
